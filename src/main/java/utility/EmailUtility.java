...
public class EmailUtility {
	  ...
	  public static Mail buildResponseEmail(Long ticketId, String responseText) {
		    Email from = new Email("vasanthantamilan@gmail.com");
		    String subject = "New response has been added to your ticket "+ticketId;
		    Email to = new Email("vasanthanchinnasamy@gmail.com");
	  ...
	  public static void sendResponseMail(Long ticketId, String responseText) throws IOException {
		    final Mail resposeMail = buildResponseEmail(ticketId, responseText);
		    send(resposeMail);
		  }
